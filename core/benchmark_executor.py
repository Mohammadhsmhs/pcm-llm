...
from utils.loggers.thread_safe_logger import ThreadSafeLogger
...
from utils.data.data_utils import extract_task_data, initialize_sample_result, get_model_name
...
class BenchmarkExecutor:
    ...
    def _run_compression_pipeline(self, task_name: str, prompts: List[str],
        ...
        from utils.data.data_utils import write_intermediate_csv
