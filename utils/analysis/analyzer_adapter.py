...
class DataAnalyzer:
    ...
    def __init__(
        self, sample_data: Dict, compression_methods: set, results_dir: str = "results"
    ):
        ...
        for sample_id, sample in self.sample_data.items():
            for method in self.compression_methods:
                ...
                enhancer_input = {
                    ...
                    "target_compression_ratio": method_data.get(
                ...
                record = {
                    ...
                    "actual_compression_ratio": enhanced_data.get(
                        "actual_compression_ratio", 0.0
                    ),
                    "score_preservation": enhanced_data.get("score_preservation", 0.0),
                    "compression_efficiency": enhanced_data.get(
                        "compression_efficiency", 0.0
                    ),
                    "quality_degradation": enhanced_data.get(
                        "quality_degradation", 0.0
                    ),
                    "latency_overhead": enhanced_data.get(
